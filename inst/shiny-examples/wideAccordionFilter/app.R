...
shinyApp(
  ui = semanticPage(
    ...
    grid(
      ...
      area_styles = list("filter1" = 'padding-right:1rem;padding-left:1rem;',
                         "filter2" = 'padding-right:1rem;padding-left:1rem;',
                         "filter3" = 'padding-right:1rem;padding-left:1rem;',
                         "filter4" = 'padding-right:1rem;padding-left:1rem;',
                         "filter5" = 'padding-right:1rem;padding-left:1rem;',
                         "filter6" = 'padding-right:1rem;padding-left:1rem;',
